    ...
    return (
      <>
        <div className="brdr-linkedin-posts mb-3 ml-2">
          ...
          <img
            src="https://images.unsplash.com/photo-1524758870432-af57e54afa26?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80"
            style={{
              width: "100%",
          ...
          <Row>
            <Col>{this.state.showComment && <Comment />}</Col>
          </Row>
        </div>
        <DeletePost
